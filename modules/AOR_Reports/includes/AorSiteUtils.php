...
require_once ROOTPATH.'/include/SugarObjects/SugarConfig.php';
require_once ROOTPATH.'/include/utils/security_utils.php';
require_once ROOTPATH.'/include/utils/db_utils.php';
...
class AorSiteUtils {
    ...
    public static function make_sugar_config(&$sugar_config)
    {
    ...
    public static function get_sugar_config_defaults()
    {
        global $locale;
        /*
...
//	'use_php_code_json' => returnPhpJsonStatus(),
     ...
     */
    public static function load_menu($path)
    {
        global $module_menu;
     ...
     */
    public static function get_notify_template_file($language)
    {
        /*
         * Order of operation:
    ...
    public static function sugar_config_union($default, $override)
    {
    ...
    public static function make_not_writable($file)
    {
    ...
    public static function get_language_display($key)
    {
        global $sugar_config;
    ...
    public static function get_assigned_user_name($assigned_user_id, $is_group = '')
    {
...
//TODO Update to use global cache
     ...
     */
    public static function get_user_array($add_blank = true, $status = 'Active', $user_id = '', $use_real_name = false, $user_name_filter = '', $portal_filter = ' AND portal_only=0 ', $from_cache = true)
    {
     ...
     */
    public static function getUserArrayFromFullName($args, $hide_portal_users = false)
    {
        global $locale;
        $db = DBManagerFactory::getInstance();
    ...
    public static function clean($string, $maxLength)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function safe_map($request_var, &$focus, $always_copy = false)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function safe_map_named($request_var, &$focus, $member_var, $always_copy)
    {
     ...
     */
    public static function return_app_list_strings_language($language)
    {
     ...
     */
//jchi 25347
    public static function _mergeCustomAppListStrings($file, $app_list_strings)
    {
     ...
     * @return array lang strings
     */
    public static function return_application_language($language)
    {
     ...
     * @return array lang strings
     */
    public static function return_module_language($language, $module, $refresh = false)
    {
        global $mod_strings;
        global $sugar_config;
    ...
    public static function return_mod_list_strings_language($language, $module)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function return_theme_language($language, $theme)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function return_session_value_or_default($varname, $default)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function append_where_clause(&$where_clauses, $variable_name, $SQL_name = null)
    {
        if ($SQL_name == null) {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function generate_where_statement($where_clauses)
    {
        $where = '';
...
// check if Studio is displayed.
    public static function displayStudioForCurrentUser()
    {
        global $current_user;
    ...
    public static function displayWorkflowForCurrentUser()
    {
...
// return an array with all modules where the user is an admin.
    public static function get_admin_modules_for_user($user)
    {
    ...
    public static function get_workflow_admin_modules_for_user($user)
    {
...
// Check if user is admin for at least one module.
    public static function is_admin_for_any_module($user)
    {
        if (!isset($user)) {
            return false;
        }
...
// Check if user is admin for a specific module.
    public static function is_admin_for_module($user, $module)
    {
        if (!isset($user)) {
            return false;
        }
     ...
     */
    public static function get_theme_display($theme)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function get_select_options($option_list, $selected)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function get_select_options_with_id($option_list, $selected_key)
    {
     ...
     * Contributor(s): ______________________________________..
     */
    public static function get_select_options_with_id_separate_key($label_list, $key_list, $selected_key, $massupdate = false)
    {
        global $app_strings;
        $select_options = '';
     ...
     * exit code.
     */
    public static function sugar_die($error_message, $exit_code = 1)
    {
        global $focus;
        sugar_cleanup();
        //echo $error_message;
     ...
     * Contributor(s): ______________________________________..
     */
    public static function get_clear_form_js()
    {
        $the_script = <<<EOQ
...
EOQ;
     ...
     * Contributor(s): ______________________________________..
     */
    public static function get_set_focus_js()
    {
...
EOQ;
    ...
    public static function translate($string, $mod = '', $selectedValue = '')
    {
        //$test_start = microtime();
        //public static $mod_strings_results = array();
        if (!empty($mod)) {
    ...
    public static function unTranslateNum($num)
    {
        static $dec_sep;
        static $num_grp_sep;
        global $current_user, $sugar_config;
     ...
     * @return array
     */
    public static function getDefaultXssTags()
    {
        $tmp = array(
            'applet' => 'applet',
            'base' => 'base',
     ...
     */
    public static function clean_xss($str, $cleanImg = true)
    {
        global $sugar_config;
     ...
     * @return array
     */
    public static function xss_check_pattern($pattern, $str)
    {
    ...
    public static function clean_special_arguments()
    {
     ...
     */
    public static function clean_superglobals($key, $filter = 'STANDARD')
    {
        if (isset($_GET[$key])) {
    ...
    public static function set_superglobals($key, $val)
    {
        $_GET[$key] = $val;
        $_POST[$key] = $val;
        $_REQUEST[$key] = $val;
...
// Works in conjunction with clean_string() to defeat SQL injection, file inclusion attacks, and XSS
    public static function clean_incoming_data()
    {
        global $sugar_config;
        global $RAW_REQUEST;
...
// Returns TRUE if $str begins with $begin
    public static function str_begin($str, $begin)
    {
        return substr($str, 0, strlen($begin)) == $begin;
    }

// Returns TRUE if $str ends with $end
    public static function str_end($str, $end)
    {
    ...
    public static function securexsskey($value, $die = true)
    {
        global $sugar_config;
        $matches = array();
    ...
    public static function preprocess_param($value)
    {
        if (is_string($value)) {
            if (get_magic_quotes_gpc() == 1) {
    ...
    public static function cleanup_slashes($value)
    {
        if (is_string($value)) {
    ...
    public static function set_register_value($category, $name, $value)
    {
        return sugar_cache_put("{$category}:{$name}", $value);
    }

    public static function get_register_value($category, $name)
    {
        return sugar_cache_retrieve("{$category}:{$name}");
    }

    public static function clear_register_value($category, $name)
    {
        return sugar_cache_clear("{$category}:{$name}");
    }

// this function cleans id's when being imported
    public static function convert_id($string)
    {
     ...
     */
    public static function get_image($image, $other_attributes, $width = '', $height = '', $ext = '.gif', $alt = '')
    {
     ...
     */
    public static function getImagePath($image_name)
    {
        return SugarThemeRegistry::current()->getImageURL($image_name);
    }

    public static function getWebPath($relative_path)
    {
    ...
    public static function getVersionedPath($path, $additional_attrs = '')
    {
    ...
    public static function getVersionedScript($path, $additional_attrs = '')
    {
        return '<script type="text/javascript" src="'.getVersionedPath($path, $additional_attrs).'"></script>';
    }

    public static function getJSPath($relative_path, $additional_attrs = '')
    {
        if (defined('TEMPLATE_URL')) {
            $relative_path = SugarTemplateUtilities::getWebPath($relative_path);
        }
    ...
    public static function getSWFPath($relative_path, $additional_params = '')
    {
        $path = $relative_path;
    ...
    public static function getSQLDate($date_str)
    {
    ...
    public static function clone_history(&$db, $from_id, $to_id, $to_type)
    {
        global $timedate;
        $old_note_id = null;
        $old_filename = null;
    ...
    public static function values_to_keys($array)
    {
        $new_array = array();
        if (!is_array($array)) {
            return $new_array;
    ...
    public static function clone_relationship(&$db, $tables = array(), $from_column, $from_id, $to_id)
    {
    ...
    public static function get_unlinked_email_query($type, $bean)
    {
        global $current_user;
    ...
    public static function get_emails_by_assign_or_link($params)
    {
     ...
     * @return bool
     **/
    public static function number_empty($value)
    {
        return empty($value) && $value != '0';
    }

    public static function get_bean_select_array($add_blank = true, $bean_name, $display_columns, $where = '', $order_by = '', $blank_is_none = false)
    {
        global $beanFiles;
...
// searches a list for items in a user's allowed tabs and returns an array that removes unallowed tabs from list
    public static function parse_list_modules(&$listArray)
    {
    ...
    public static function display_notice($msg = false)
    {
        global $error_notice;
     ...
     */
    public static function skype_formatted($number)
    {
        //kbrill - BUG #15375
...
//	return substr($number, 0, 1) == '+' || substr($number, 0, 2) == '00' || substr($number, 0, 2) == '011';
    ...
    public static function format_skype($number)
    {
        return preg_replace('/[^\+0-9]/', '', $number);
    }

    public static function insert_charset_header()
    {
    ...
    public static function javascript_escape($str)
    {
        $new_str = '';
    ...
    public static function js_escape($str, $keep = true)
    {
     ...
     */
    public static function _ppd($mixed)
    {
    }
     ...
     */
    public static function _ppl($mixed, $die = false, $displayStackTrace = false, $loglevel = 'fatal')
    {
     ...
     */
    public static function _ppf($bean, $die = false)
    {
    }
     ...
     */
    public static function _pp($mixed)
    {
    }
     ...
     * The pp stands for Pre Print.
     */
    public static function _pstack_trace($mixed = null)
    {
    }
     ...
     */
    public static function _ppt($mixed, $textOnly = false)
    {
    }
     ...
     */
    public static function _pptd($mixed)
    {
    }
     ...
     * This function is only intended to be used for SugarCRM internal development.
     */
    public static function decodeJavascriptUTF8($str)
    {
    }
     ...
     */
    public static function check_php_version($sys_php_version = '')
    {
     ...
     * @return 1 implies supported, 0 implies unsupported, -1 implies invalid
     */
    public static function check_iis_version($sys_iis_version = '')
    {
    ...
    public static function pre_login_check()
    {
    ...
    public static function sugar_cleanup($exit = false)
    {
        static $called = false;
        if ($called) {
            return;
...
//register_shutdown_function('sugar_cleanup'); //what does this do?
     ...
     */
    public static function check_logic_hook_file($module_name, $event, $action_array)
    {
    ...
    public static function remove_logic_hook($module_name, $event, $action_array)
    {
        require_once 'include/utils/logic_utils.php';
        $add_logic = false;
    ...
    public static function display_stack_trace($textOnly = false)
    {
        $stack = debug_backtrace();
    ...
    public static function StackTraceErrorHandler($errno, $errstr, $errfile, $errline, $errcontext)
    {
...
public static function get_sub_cookies($name)
{
    $cookies = array();
...
public static function mark_delete_components($sub_object_array, $run_second_level = false, $sub_sub_array = '')
{
 ...
 */
public static function url2html($string)
{
    //
 ...
 */
public static function is_writable_windows($file)
{
 ...
 */
public static function lookupTimezone($userOffset = 0)
{
    return \TimeDate::guessTimezone($userOffset);
}

public static function convert_module_to_singular($module_array)
{
    global $beanList;
 ...
 */
public static function get_singular_bean_name($bean_name)
{
 ...
 */
public static function get_module_from_singular($singular)
{
...
public static function get_label($label_tag, $temp_module_strings)
{
    global $app_strings;
...
public static function search_filter_rel_info(&$focus, $tar_rel_module, $relationship_name)
{
    $rel_list = array();
...
public static function get_module_info($module_name)
{
    global $beanList;
    global $dictionary;
 ...
 */
public static function get_valid_bean_name($module_name)
{
    global $beanList;
...
public static function checkAuthUserStatus()
{
 ...
 */
public static function getPhpInfo($level = -1)
{
 ...
 */
public static function string_format($format, $args)
{
    $result = $format;
 ...
 * @return $result a formatted string
 */
public static function format_number_display($num, $system_id)
{
    global $sugar_config;
...
public static function checkLoginUserStatus()
{
}
 ...
 * @return JSON object
 */
public static function getJSONobj()
{
    static $json = null;
    if (!isset($json)) {
 ...
 */
public static function setPhpIniSettings()
{
    // zlib module
 ...
 * @return array
 */
public static function sugarLangArrayMerge($gimp, $dom)
{
 ...
 */
public static function sugarArrayMerge($gimp, $dom)
{
    if (is_array($gimp) && is_array($dom)) {
        foreach ($dom as $domKey => $domVal) {
 ...
 * @return array beaten gimp
 */
public static function sugarArrayMergeRecursive($gimp, $dom)
{
    if (is_array($gimp) && is_array($dom)) {
        foreach ($dom as $domKey => $domVal) {
            if (array_key_exists($domKey, $gimp)) {
 ...
 */
public static function returnPhpJsonStatus()
{
 ...
 */
public static function getTrackerSubstring($name)
{
...
public static function generate_search_where($field_list = array(), $values = array(), &$bean, $add_custom_fields = false, $module = '')
{
    $where_clauses = array();
    $like_char = '%';
 ...
 */
public static function rebuildConfigFile($sugar_config, $sugar_version)
{
 ...
 * @return array
 */
public static function loadCleanConfig()
{
    $sugar_config = array();
    require 'config.php';
 ...
 */
public static function getJavascriptSiteURL()
{
    global $sugar_config;
...
public static function add_squotes($str)
{
    return "'".$str."'";
}
 ...
 */
public static function createGroupUser($name)
{
    $group = new User();
...
public static function _getIcon($iconFileName)
{
 ...
 */
public static function getStudioIcon($iconFileName = '', $altFileName = '', $width = '48', $height = '48', $align = 'baseline', $alt = '')
{
 ...
 * @return string $string <img> tag with corresponding image
 */
public static function get_dashlets_dialog_icon($module = '', $width = '32', $height = '32', $align = 'absmiddle', $alt = '')
{
    global $app_strings, $theme;
...
public static function str_split_php4($string, $length = 1)
{
 ...
 */
public static function is_freetds()
{
 ...
 */
public static function chartStyle()
{
 ...
 * @return object
 */
public static function loadBean($module) {
 ...
 */
public static function isTouchScreen()
{
 ...
 */
public static function get_alt_hot_key()
{
    $ua = '';
...
public static function load_link_class($properties)
{
    $class = 'Link2';
...
public static function inDeveloperMode()
{
 ...
 */
public static function filterInboundEmailPopSelection($protocol)
{
 ...
 */
public static function sugar_substr($string, $length, $charset = 'UTF-8')
{
 ...
 */
public static function sugar_ucfirst($string, $charset = 'UTF-8')
{
 ...
 * @return array
 */
public static function create_export_query_relate_link_patch($module, $searchFields, $where)
{
 ...
 */
public static function clearAllJsAndJsLangFilesWithoutOutput()
{
 ...
 */
public static function getVariableFromQueryString($variable, $string)
{
    $matches = array();
 ...
 */
public static function should_hide_iframes()
{
 ...
 * @return string
 */
public static function sugar_microtime()
{
 ...
 */
public static function verify_image_file($path, $jpeg = false)
{
 ...
 */
public static function verify_uploaded_image($path, $jpeg_only = false)
{
...
public static function cmp_beans($a, $b)
{
...
public static function order_beans($beans, $field_name)
{
 ...
 */
public static function sql_like_string($str, $like_char, $wildcard = '%', $appendWildcard = true)
{
 ...
 */
public static function sanitize($input, $quotes = ENT_QUOTES, $charset = 'UTF-8', $remove = false)
{
 ...
 */
public static function getFTSEngineType()
{
 ...
 */
public static function getFTSBoostOptions($optionName)
{
 ...
 */
public static function utf8_recursive_encode($data)
{
    $result = array();
 ...
 */
public static function get_language_header()
{
 ...
 */
public static function get_custom_file_if_exists($file)
{
 ...
 */
public static function get_help_url($send_edition = '', $send_version = '', $send_lang = '', $send_module = '', $send_action = '', $dev_status = '', $send_key = '', $send_anchor = '')
{
    global $sugar_config;
 ...
 */
public static function generateETagHeader($etag)
{
 ...
 */
public static function getReportNameTranslation($reportName)
{
    global $current_language;
 ...
 */
public static function clean_sensitive_data($defs, $data)
{
 ...
 */
public static function getDuplicateRelationListWithTitle($def, $var_def, $module)
{
    global $current_language;
 ...
 * @return array
 */
public static function getTypeDisplayList()
{
 ...
 * @param string    $value
 */
public static function assignConcatenatedValue(SugarBean $bean, $fieldDef, $value)
{
 ...
 */
public static function sugar_unserialize($value)
{
...
public static function suite_strlen($input, $encoding = DEFAULT_UTIL_SUITE_ENCODING)
{
    if (function_exists('mb_strlen')) {
...
public static function suite_substr($input, $start, $length = null, $encoding = DEFAULT_UTIL_SUITE_ENCODING)
{
...
public static function suite_strtoupper($input, $encoding = DEFAULT_UTIL_SUITE_ENCODING)
{
...
public static function suite_strtolower($input, $encoding = DEFAULT_UTIL_SUITE_ENCODING)
{
...
public static function suite_strpos($haystack, $needle, $offset = 0, $encoding = DEFAULT_UTIL_SUITE_ENCODING)
{
...
public static function suite_strrpos($haystack, $needle, $offset = 0, $encoding = DEFAULT_UTIL_SUITE_ENCODING)
{
